let GameManager = {
    ...
    resetPlayer: function(classType){
        switch (classType) {
          ...
          classType.toLowerCase() +'.png" class="img-avatar"><div><h3>'+ classType +
           ...
           '</p><p>Strengh: '+ player.strength + '</p><p>Agility: ' + player.agility +
    ...
    setFight: function(){
        ...
        getEnemy.innerHTML = '<img src="images/avatar-enemies/' + enemy.enemyType.toLowerCase() + '.png" alt =" '
        + enemy.enemyType + '"class = "img-avatar"><div><h3>' + enemy.enemyType +'</p><p>Mana: '
        + enemy.mana + '</p><p>Strength: '+ enemy.strength + '</p><p>Agility: '+enemy.agility
